...
class KomentarAlterFk extends \CodeIgniter\Database\Migration
{
    ...
    public function up()
    {
        ...
        $this->forge->dropForeignKey('komentar', 'komentar_id_stuff_foreign');
        ...
        $this->forge->addColumn('komentar', [
            'CONSTRAINT komentar_id_stuff_foreign FOREIGN KEY(id_stuff) REFERENCES stuff(id) ON DELETE NO ACTION ON UPDATE CASCADE',
        ]);
    }
    public function down()
    {
        ...
        $this->forge->addColumn('komentar', [
            'CONSTRAINT komentar_id_stuff_foreign FOREIGN KEY(id_stuff) REFERENCES stuff(id)',
        ]);
    }
}
